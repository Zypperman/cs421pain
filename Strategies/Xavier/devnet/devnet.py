...
os.environ["TF_CPP_MIN_LOG_LEVEL"] = "2"    # suppresses the FutureWarning spam
...
parser.add_argument("--data_set", type=str, default='user_features_with_labels', help="a list of data set names")
...
parser.add_argument("--output", type=str, default='./results/results.csv', help="the output file path")
